...
interface FileUploaderProps {
    ...
    handleFileUpload: (e: React.ChangeEvent<HTMLInputElement>, fieldName: string) => void;
    removeFile: (fieldName: string) => void;
}

const FileUploader = ({ fieldName, label, description, icon: Icon, previews, handleFileUpload, removeFile }: FileUploaderProps) => {
